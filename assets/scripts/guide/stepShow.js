...
cc.Class({
    ...
    onLoad() {
        ...
        if (CACHE.userInfo && typeof CACHE.userInfo.stage == 'number' && CACHE.userInfo.stage !== 99) {
            if (CACHE.userInfo.stage == 2) {
                ...
                this.guideToastNode.setPosition(cc.v2(0, -300));
                ...
                this.guideToastArrowNode.setPosition(cc.v2(0, 200));
                ...
                this.guideToastNode.parent = this.node;
                this.guideToastNode.setPosition(cc.v2(0, 50));
                this.node.on(cc.Node.EventType.TOUCH_START, this.onTouchStart, this);
                this.node.on(cc.Node.EventType.TOUCH_MOVE, this.onTouchMove, this);
                this.node.on(cc.Node.EventType.TOUCH_END, this.onTouchEnd, this);
            }
    ...
    guide(isEnd) {
        if (CACHE.userInfo.stage == 2 && this.guideStep == 1) {
            if (isEnd) {
                ...
                this.guideToastArrowNode.setPosition(cc.v2(100, 370));
            ...
            if (isEnd) {
                ...
                this.guideToastNode.active = true;
                this.guideToastArrowNode.setPosition(cc.v2(0, 0));
    ...
    onTouchEnd(event) {
        ...
        if (this._isPressIn && this.isUserPressIn(event, true)) {//this.isUserPressIn(event, true)
